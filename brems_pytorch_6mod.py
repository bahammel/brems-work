...
if __name__ == '__main__':
    ...
    for epoch in range(EPOCHS):
        ...
        if epoch % 10 == 0:
            ...
            print(
                f"epoch: {epoch}, mean train loss: {train_loss:.4f}, mean test loss: {test_loss:.4f}"
            )
    ...
    '''
    plt.scatter(Ytrain[:,0], Xtrain.mean(1), c='g')
    plt.scatter(Ytest[:,0],Xtest.mean(1),  c='r')
    plt.scatter(I_[:,0].detach().squeeze(-1), Xtest.mean(1),  c='m')
    ...
    plt.scatter(Ytrain[:,1], Xtrain.mean(1), c='g')
    plt.scatter(Ytest[:,1],Xtest.mean(1),  c='r')
    plt.scatter(I_[:,1].detach().squeeze(-1), Xtest.mean(1),  c='m')
    plt.ylabel('Int (Xtest.mean(1)')
